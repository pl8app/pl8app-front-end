...
export const DEFAULT_META: PageMeta = {
  title: 'pl8app DEX',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by pl8app DEX), NFTs, and more, on a platform you can trust.',
...
export const getCustomMeta = (path: string, t: ContextApi['t']): PageMeta => {
  ...
  switch (basePath) {
    ...
    case '/add':
      return {
        title: `${t('Add Liquidity')} | ${t('pl8app DEX')}`,
      }
    case '/remove':
      return {
        title: `${t('Remove Liquidity')} | ${t('pl8app DEX')}`,
      }
    case '/liquidity':
      return {
        title: `${t('Liquidity')} | ${t('pl8app DEX')}`,
      }
    case '/find':
      return {
        title: `${t('Import Pool')} | ${t('pl8app DEX')}`,
      }
    case '/competition':
      return {
